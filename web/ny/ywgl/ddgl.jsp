...
<form action="/96909/YwglSvl?">
  <input type="hidden" name="reqType" value="queryTransactionByJs">
  <table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="MENU_line">
    <tr>
      <td width="67%" align="right" class="text" nowrap>&nbsp;雇主：
        <input type="text" name="e_name" maxlength="20" size="12" value="" class="input">
        &nbsp; 登记日期：
        <input type="text" name="mininputtime" maxlength="20" size="12" value="" class="input">
        到
        <input type="text" name="maxinputtime" maxlength="20" size="12" value="" class="input">
        &nbsp; 雇用工人：
        <input type="text" name="w_name" maxlength="20" size="12" value="" class="input">
&nbsp;状态：
        ...
        <input type="button" value="新  增" class="button_new"onClick="javascript:location.href='/96909/YwglSvl?reqType=allWE'" >
...
<br>
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    ...
    <c:forEach items="${tlist}" var="t">
      ...
      <td nowrap align="center" width="4%">${t.id}</td>
      <td align="center" nowrap>${t.e_name}</td>
      <td height="14" align="center" nowrap>${t.e_phone}</td>
      <td align="center" nowrap>${t.w_name}</td>
      <td align="center" nowrap>${t.w_phone}</td>
      <td align="center" nowrap>${t.price}</td>
      <td align="center" nowrap>${t.type}</td>
      <td align="center" nowrap>${t.status}</td>
      <td align="center" nowrap>
        <a href="${pageContext.request.contextPath}/YwglSvl?reqType=seeEmployer&eid=${t.e_id}">查看</a>
        <a href="ny/ywgl/ddgl_xg.htm">修改</a></td>
    </tr>
    </c:forEach>
  </table>
