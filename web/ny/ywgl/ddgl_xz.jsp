...
<form action="/96909/YwglSvl?">
  <input type="hidden" name="reqType" value="addTransaction">
...
女</td>
    ...
    <tr>
      ...
      <td align="left" bgcolor="#FFFFFF">
        <input name="phone" type="text" id="textarea22"  size="15" class="pi">
      </td>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF">
        <input name="charge" type="text" size="20" class="pi"></td>
    </tr>
   ...
   <!-- <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><input name="w_phone" type="text" size="30" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">电话：</td>
      <td bgcolor="#FFFFFF"><input name="w_phone2" type="text"  size="30" class="pi"></td>
    </tr>
    <!--<tr>
	...
	<tr>
      ...
      <td colspan="7" bgcolor="#FFFFFF">
        <input type="checkbox" name="t_type" value="月嫂"/>
        月嫂
&nbsp;
        <input type="checkbox" name="t_type"  value="保姆" />
保姆&nbsp;&nbsp;
        <input type="checkbox" name="t_type"  value="钟点"  />
钟点&nbsp;&nbsp;
        <input type="checkbox" name="t_type"  value="厨嫂"  />
厨嫂
        <input type="checkbox" name="t_type"  value="清洁工" />
清洁工
&nbsp;
        <input type="checkbox" name="t_type" value="护工"  />
 护工&nbsp;&nbsp;
         <input type="checkbox" name="t_type"  value="早教" />
 早教
&nbsp;&nbsp;
        <input type="checkbox" name="t_type"   value="家教" />
家教
&nbsp;&nbsp;
        <input type="checkbox" name="t_type"  value="高级管家" />
高级管家<br>
备注：
        <input name="t_type" type="text" size="40" class="pi"></td>
    </tr>
	  <tr>
    ...
    <tr>
      ...
      <td align="left" bgcolor="#FFFFFF"><input name="chargeman" type="text" id="textarea21" value="" size="14" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">工资:</td>
      <td align="left" bgcolor="#FFFFFF"><input name="price" type="text" id="textarea21" value="" size="14" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">订单有效期:</td>
      <td align="left" bgcolor="#FFFFFF"><input name="validity" type="text" id="textarea27" value="" size="14" class="pi"></td>
      <td align="right" bgcolor="#FFFFFF">状态：</td>
      <td align="left" bgcolor="#FFFFFF"><span class="text">
        <select name="stutus" id="select" class="input">
          <option>请选择</option>
