...
<form action="${pageContext.request.contextPath}/XtglSvl">
    <input type="hidden" name="reqType" value="jsKfjl">
  <table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="MENU_line">
    <tr>
      <td width="67%" align="right" class="text" nowrap>&nbsp;公司名称：
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;公司帐号：
        <input type="text" name="accid" maxlength="20" size="12" value="" class="input">
 &nbsp;&nbsp;&nbsp;&nbsp;日期：
        <input type="text" name="mindate" maxlength="20" size="12" class="input">
        到
        <input type="text" name="maxdate" maxlength="20" size="12" class="input"> &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
    <tr align="center" class="tdtitle">
      ...
      <td width="9%" align="center" nowrap id=".name" >帐号</td>
      ...
      <c:forEach items="${kfjlList}" var="kfjl">
        <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
          <td width="4%" height="14" align="center" nowrap>${kfjl.id}</td>
          <td align="center" nowrap>${kfjl.companyname}</td>
          <td align="center" nowrap>${kfjl.userid}</td>
          <td align="center" nowrap>${kfjl.skdate}</td>
          <td align="center" nowrap>${kfjl.jine}</td>
        </tr>
      </c:forEach>
          ...
          <table width="90%" style="font-size:12px;" border="0" cellspacing="3" cellpadding="2">
            <tr>
              ...
              <td nowrap width="55%" align="right"><input type="hidden" name="currentPage" value="1">
                  ...
                  <img src="../image/Next_no.gif" alt="下一页" width="14" height="13" border="0">&nbsp&nbsp&nbsp
                  <img src="../image/Last_no.gif" alt="最后一页" width="18" height="13" border="0">&nbsp&nbsp&nbsp
